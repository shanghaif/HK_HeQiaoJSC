...
{
    public class PyramidSaleViewModel
    {
        public Guid PyramidSaleUuid { get; set; }
        ...
        public string UnlawfulAct { get; set; }
        public string PenaltyType { get; set; }
        public string PyramidSaleType { get; set; }
        public string PyramidSaleClass { get; set; }
        public string Attention { get; set; }
        public string BindingHours { get; set; }
        public string BindingHoursEnd { get; set; }
    }
}
