...
namespace HaikanSmartTownCockpit.Api.Controllers.Api.V1.PublicityInfo
{
    ...
    [ApiController]
    public class PropaTypeController : ControllerBase
    {
        ...
        public PropaTypeController(haikanHeQiaoContext dbContext, IMapper mapper, IWebHostEnvironment hostingEnvironment)
        {
        ...
        public IActionResult PTypefoGet(Guid guid)
        {
            using (_dbContext)
            {
                var query1 = from c in _dbContext.Propaganda
                             where c.PropagandaTypeUuid == guid
                             select new
                             {
                                 c.Id,
                                 c.PropagandaTypeName,
