...
namespace HaikanSmartTownCockpit.Api.Controllers.Api.V1.Task
{
    ...
    [ApiController]
    public class wochuangjianController : ControllerBase
    {

        private readonly haikanHeQiaoContext _dbContext;
        private readonly IMapper _mapper;

        public wochuangjianController(haikanHeQiaoContext dbContext, IMapper mapper)
        {
        ...
        public IActionResult List(alltaskrequestpayload payload)
        {
            using (_dbContext)
            {
                ...
                ToLog.AddLog("查询", "成功:查询:我创建的任务信息数据", _dbContext);
                return Ok(response);
            }
        }
