...
namespace HaikanSmartTownCockpit.Api.Controllers.Api.V1.Organization
{
    ...
    public class ChildController : ControllerBase
    {
        ...
        public ChildController(haikanHeQiaoContext dbContext, IMapper mapper, IWebHostEnvironment hostingEnvironment)
        {
        ...
        public IActionResult Import(IFormFile excelfile)
        {
            ...
            using (_dbContext)
            {
                ...
                string uploadtitle = "留守儿童信息导入" + DateTime.Now.ToString("yyyyMMddHHmmss");
        ...
        public IActionResult ExportPass(string ids)
        {
            ...
            using (_dbContext)
            {
                if (ids != null)
                {
                    ...
                    string sWebRootFolder = _hostingEnvironment.WebRootPath + "\\UploadFiles\\ImportBuidingExcel\\";
                    string uploadtitle = "留守儿童信息导出" + DateTime.Now.ToString("yyyyMMddHHmmss");
                ...
                else
                {
                    ...
                    var query = _dbContext.OrganPeoInfo.Where(x => x.IsDeleted != 1 && x.OrganizationUuid == oquery.OrganizationUuid && x.ManType == "留守儿童").Select(x => new HaikanSmartTownCockpit.Api.Entities.OrganPeoInfo
                    {
                        OrganName = x.OrganName,
                        Sex = x.Sex,
                        Birth = x.Birth,
        ...
        public static bool TablesToExcel(List<HaikanSmartTownCockpit.Api.Entities.OrganPeoInfo> query, string filename)
        {
            ...
            ISheet sheet = workBook.CreateSheet("留守儿童信息表");
