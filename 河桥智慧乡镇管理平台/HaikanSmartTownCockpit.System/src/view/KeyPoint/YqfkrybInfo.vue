  ...
  <div>
    ...
    >
      ...
      >
        ...
        <Row :gutter="16">
          <FormItem label="所属网格" prop="ownedNetwork">
            <Input
              v-model="formModel.fields.ownedNetwork"
              placeholder="所属网格"
            />
          </FormItem>
        </Row>
        ...
        <Row :gutter="16">
          <FormItem label="关注原因" prop="reasonForConcern">
            <Input
              v-model="formModel.fields.reasonForConcern"
              placeholder="关注原因"
            />
          </FormItem>
        </Row>
        ...
        <Row :gutter="16">
          <FormItem
            label="疫情防控状态"
            prop="epidemicPreventionAndControlStatus"
          >
            <Input
              v-model="formModel.fields.epidemicPreventionAndControlStatus"
              placeholder="疫情防控状态"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="来源地" prop="origin">
            <Input v-model="formModel.fields.origin" placeholder="来源地" />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="服务处所" prop="servicePremises">
            <Input
              v-model="formModel.fields.servicePremises"
              placeholder="服务处所"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="隔离时间" prop="isolationTime">
            <Input
              v-model="formModel.fields.isolationTime"
              placeholder="隔离时间"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="去往地点" prop="whereToGo">
            <Input
              v-model="formModel.fields.whereToGo"
              placeholder="去往地点"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="去往地址" prop="toAddress">
            <Input
              v-model="formModel.fields.toAddress"
              placeholder="去往地址"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem
            label="家庭成员联系方式"
            prop="familyMemberContactInformation"
          >
            <Input
              v-model="formModel.fields.familyMemberContactInformation"
              placeholder="家庭成员联系方式"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="去往地址联络人" prop="goToAddressContact">
            <Input
              v-model="formModel.fields.goToAddressContact"
              placeholder="去往地址联络人"
            />
          </FormItem>
        </Row>
        ...
        <Row :gutter="16">
          <FormItem label="联络人手机号码" prop="contactPhoneNumber">
            <Input
              v-model="formModel.fields.contactPhoneNumber"
              placeholder="联络人手机号码"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem
            label="返回或预计返回时间"
            prop="returnOrEstimatedReturnTime"
          >
            <Input
              v-model="formModel.fields.returnOrEstimatedReturnTime"
              placeholder="返回或预计返回时间"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="交通方式" prop="transportation">
            <Input
              v-model="formModel.fields.transportation"
              placeholder="交通方式"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="有无疑似发热" prop="yesNoSuspectedFever">
            <Input
              v-model="formModel.fields.yesNoSuspectedFever"
              placeholder="有无疑似发热"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="排查方式" prop="checkMethod">
            <Input
              v-model="formModel.fields.checkMethod"
              placeholder="排查方式"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="责任医生姓名" prop="nameOfResponsibleDoctor">
            <Input
              v-model="formModel.fields.nameOfResponsibleDoctor"
              placeholder="责任医生姓名"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="责任医生电话" prop="phoneNumberOfResponsibleDoctor">
            <Input
              v-model="formModel.fields.phoneNumberOfResponsibleDoctor"
              placeholder="责任医生电话"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="服务成员信息" prop="serviceMemberInformation">
            <Input
              v-model="formModel.fields.serviceMemberInformation"
              placeholder="服务成员信息"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="监护人员信息" prop="guardianInformation">
            <Input
              v-model="formModel.fields.guardianInformation"
              placeholder="监护人员信息"
            />
          </FormItem>
        </Row>
    ...
    >
      ...
      >
        ...
        <Row :gutter="16">
          <FormItem label="所属网格" prop="ownedNetwork">
            <Input
              v-model="formModel1.fields.ownedNetwork"
              placeholder="所属网格"
              :readonly="true"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="关注原因" prop="reasonForConcern">
            <Input
              v-model="formModel1.fields.reasonForConcern"
              :readonly="true"
              placeholder="关注原因"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          ...
          >
            <Input
              v-model="formModel1.fields.epidemicPreventionAndControlStatus"
              :readonly="true"
              placeholder="疫情防控状态"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="来源地" prop="origin">
            <Input
              v-model="formModel1.fields.origin"
              :readonly="true"
              placeholder="来源地"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="隔离时间" prop="isolationTime">
            <Input
              v-model="formModel1.fields.isolationTime"
              :readonly="true"
              placeholder="隔离时间"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="去往地点" prop="whereToGo">
            <Input
              v-model="formModel1.fields.whereToGo"
              :readonly="true"
              placeholder="去往地点"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="去往地址" prop="toAddress">
            <Input
              v-model="formModel1.fields.toAddress"
              :readonly="true"
              placeholder="去往地址"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          ...
          >
            <Input
              v-model="formModel1.fields.familyMemberContactInformation"
              :readonly="true"
              placeholder="家庭成员联系方式"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="去往地址联络人" prop="goToAddressContact">
            <Input
              v-model="formModel1.fields.goToAddressContact"
              :readonly="true"
              placeholder="去往地址联络人"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="联络人手机号码" prop="contactPhoneNumber">
            <Input
              v-model="formModel1.fields.contactPhoneNumber"
              :readonly="true"
              placeholder="联络人手机号码"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          ...
          >
            <Input
              v-model="formModel1.fields.returnOrEstimatedReturnTime"
              :readonly="true"
              placeholder="返回或预计返回时间"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="交通方式" prop="transportation">
            <Input
              v-model="formModel1.fields.transportation"
              :readonly="true"
              placeholder="交通方式"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="有无疑似发热" prop="yesNoSuspectedFever">
            <Input
              v-model="formModel1.fields.yesNoSuspectedFever"
              :readonly="true"
              placeholder="有无疑似发热"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="排查方式" prop="checkMethod">
            <Input
              v-model="formModel1.fields.checkMethod"
              :readonly="true"
              placeholder="排查方式"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="责任医生姓名" prop="nameOfResponsibleDoctor">
            <Input
              v-model="formModel1.fields.nameOfResponsibleDoctor"
              :readonly="true"
              placeholder="责任医生姓名"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="责任医生电话" prop="phoneNumberOfResponsibleDoctor">
            <Input
              v-model="formModel1.fields.phoneNumberOfResponsibleDoctor"
              :readonly="true"
              placeholder="责任医生电话"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="服务成员信息" prop="serviceMemberInformation">
            <Input
              v-model="formModel1.fields.serviceMemberInformation"
              :readonly="true"
              placeholder="服务成员信息"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="监护人员信息" prop="guardianInformation">
            <Input
              v-model="formModel1.fields.guardianInformation"
              :readonly="true"
              placeholder="监护人员信息"
            />
          </FormItem>
    ...
    >
      <div>
        ...
        <Button
          ...
          title="疫情防控人员清单导入模板下载"
          >疫情防控人员清单导入模板下载</Button
        >
        <Button
          icon="md-checkmark-circle"
          type="primary"
...
import {
  ...
  GetImport, //导入
  GetExport, //导出
} from "@/api/KeyPoint/YqfkrybInfo";
import config from "@/config";
import { getToken } from "@/libs/util";
export default {
  name: "ListOfKeyPetInfo",
  components: {
    DzTable,
  },
  data() {
    return {
      ...
      stores: {
        userinfo: {
          ...
          //列表显示
          columns: [
            { type: "selection", minwidth: 50, key: "yqfkrybuuid" },
            {
              title: "姓名",
              key: "name",
              minWidth: 120,
      ...
      formModel: {
        ...
        fields: {
          ...
          reasonForConcern: "",
          attention: "",
          epidemicPreventionAndControlStatus: "",
          origin: "",
          servicePremises: "",
          currentAddress: "",
          isolationTime: "",
          ...
          whereToGo: "",
          toAddress: "",
          familyMemberContactInformation: "",
          goToAddressContact: "",
          contactPhone: "",
          contactPhoneNumber: "",
          returnOrEstimatedReturnTime: "",
          transportation: "",
          yesNoSuspectedFever: "",
          checkMethod: "",
          nameOfResponsibleDoctor: "",
          phoneNumberOfResponsibleDoctor: "",
  ...
  computed: {
    ...
    selectedRowsId() {
      return this.formModel.selection.map((x) => x.yqfkrybuuid);
    }, //删除
  },
  methods: {
    //页面加载
    ...
    handleEdit(row) {
      ...
      this.formModel.opened = true;
      this.handleResetFormDispatch(); //清空表单
      this.doLoadData(row.yqfkrybuuid);
    },
    //右边详情
    handleDetail(row) {
    ...
    handleSubmitConsumable() {
      ...
      if (this.formModel.fields.sex != "") {
        if (
          this.formModel.fields.sex != "男" &&
          this.formModel.fields.sex != "女"
        ) {
    ...
    handleimportmodel() {
      ...
      window.location.href =
        this.url + "UploadFiles/KeyPointModel/疫情防控人员清单导入模板.xlsx";
    },
    //导入
    importfxx(e) {
