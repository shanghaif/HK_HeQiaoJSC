  ...
  <div>
    ...
    >
      ...
      >
        ...
        <Row :gutter="16">
          <FormItem label="危险程度" prop="danger">
            <Input v-model="formModel.fields.danger" placeholder="危险程度" />
          </FormItem>
        </Row>
        <Row :gutter="16">
        ...
        <Row :gutter="16">
          <FormItem label="重病名称" prop="diseaseName">
            <Input
              v-model="formModel.fields.diseaseName"
              placeholder="重病名称"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="是否接受过治疗" prop="treatment">
            <Input
              v-model="formModel.fields.treatment"
              placeholder="是否接受过治疗"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="康复机构" prop="rehabilitation">
            <Input
              v-model="formModel.fields.rehabilitation"
              placeholder="康复机构"
            />
          </FormItem>
        </Row>
    ...
    >
      ...
      >
        ...
        <Row :gutter="16">
          <FormItem label="危险程度" prop="danger">
            <Input
              v-model="formModel1.fields.danger"
              :readonly="true"
              placeholder="危险程度"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="重病名称" prop="diseaseName">
            <Input
              v-model="formModel1.fields.diseaseName"
              :readonly="true"
              placeholder="重病名称"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="是否接受过治疗" prop="treatment">
            <Input
              v-model="formModel1.fields.treatment"
              :readonly="true"
              placeholder="是否接受过治疗"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="康复机构" prop="rehabilitation">
            <Input
              v-model="formModel1.fields.rehabilitation"
              :readonly="true"
              placeholder="康复机构"
            />
          </FormItem>
    ...
    <Drawer
      title="精神病人员信息导入(导入信息时,性别和生日自动从身份证获取,请保证身份证输入正确)"
...
import {
  ...
  GetImport, //导入
  GetExport, //导出
} from "@/api/KeyPoint/MentallyInfo";
    ...
    return {
      ...
      stores: {
        userinfo: {
          ...
          //列表显示
          columns: [
            { type: "selection", minwidth: 50, key: "mentallyUuid" },
            {
              title: "姓名",
              key: "name",
              minWidth: 120,
  ...
  methods: {
    ...
    handleimportmodel() {
      ...
      window.location.href =
        this.url + "UploadFiles/KeyPointModel/精神病人员信息导入模板.xlsx";
    },
    //导入
    importfxx(e) {
