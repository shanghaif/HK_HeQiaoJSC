  ...
  <div>
    ...
    >
      ...
      >
        ...
        <Row :gutter="16">
          <FormItem label="出生日期" prop="dateOfBirth">
            <DatePicker
              v-model="formModel.fields.dateOfBirth"
              @on-change="formModel.fields.dateOfBirth = $event"
              format="yyyy-MM-dd"
              type="date"
              placeholder="出生日期"
              style="width: 150px"
        ...
        <Row :gutter="16">
          <FormItem
            label="户籍派出所"
            prop="householdRegistrationPoliceStation"
          >
            <Input
              v-model="formModel.fields.householdRegistrationPoliceStation"
              placeholder="户籍派出所"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="房屋编号" prop="numberOfTheHouse">
            <Input
              v-model="formModel.fields.numberOfTheHouse"
              placeholder="房屋编号"
            />
          </FormItem>
        </Row>
        ...
        <Row :gutter="16">
          <FormItem label="无房原因" prop="noRoomReason">
            <Input
              v-model="formModel.fields.noRoomReason"
              placeholder="无房原因"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="刑满释放地址" prop="otherAddress">
            <Input
        ...
        <Row :gutter="16">
          <FormItem label="联系手机" prop="contactNumber">
            <Input
              v-model="formModel.fields.contactNumber"
              placeholder="联系手机"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="家庭成员联系电话" prop="familyPhone">
            <Input
              v-model="formModel.fields.familyPhone"
              placeholder="家庭成员联系电话"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
        ...
        <Row :gutter="16">
          <FormItem label="宗教信仰" prop="religiousBelief">
            <Input
              v-model="formModel.fields.religiousBelief"
              placeholder="宗教信仰"
            />
          </FormItem>
        </Row>
        ...
        <Row :gutter="16">
          <FormItem label="有无服务成员" prop="serviceMembers">
            <Input
              v-model="formModel.fields.serviceMembers"
              placeholder="有无服务成员"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="最新服务时间" prop="latestServiceHours">
            <Input
              v-model="formModel.fields.latestServiceHours"
              placeholder="最新服务时间"
            />
          </FormItem>
        </Row>
        ...
        <Row :gutter="16">
          <FormItem label="管控等级" prop="controlClass">
            <Input
              v-model="formModel.fields.controlClass"
              placeholder="管控等级"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="罪名" prop="charge">
            <Input v-model="formModel.fields.charge" placeholder="罪名" />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="人员类型" prop="peopleType">
            <Input
              v-model="formModel.fields.peopleType"
              placeholder="人员类型"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="劳教场所" prop="servingPlace">
            <Input
              v-model="formModel.fields.servingPlace"
              placeholder="劳教场所"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="原判刑期" prop="sentence">
            <Input v-model="formModel.fields.sentence" placeholder="原判刑期" />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="解判刑期" prop="solutionTime">
            <Input
              v-model="formModel.fields.solutionTime"
              placeholder="解判刑期"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="是否重犯" prop="felony">
            <Input v-model="formModel.fields.felony" placeholder="是否重犯" />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="本年度是否重犯" prop="yearFelony">
            <Input
              v-model="formModel.fields.yearFelony"
              placeholder="本年度是否重犯"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="是否重点管控" prop="keytoControl">
            <Input
              v-model="formModel.fields.keytoControl"
              placeholder="是否重点管控"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="犯罪行为" prop="criminalAct">
            <Input
              v-model="formModel.fields.criminalAct"
              placeholder="犯罪行为"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="原职业" prop="professional">
            <Input
              v-model="formModel.fields.professional"
              placeholder="原职业"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="安置日期" prop="arrangeTime">
            <Input
              v-model="formModel.fields.arrangeTime"
              placeholder="安置日期"
            />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="未安置原因" prop="arrangeCause">
            <Input
              v-model="formModel.fields.arrangeCause"
              placeholder="未安置原因"
            />
          </FormItem>
        </Row>
    ...
    >
      ...
      >
        ...
        <Row :gutter="16">
          <FormItem label="出生日期" prop="dateOfBirth">
            <DatePicker
              v-model="formModel1.fields.dateOfBirth"
              @on-change="formModel1.fields.dateOfBirth = $event"
              format="yyyy-MM-dd"
              type="date"
              placeholder="出生日期"
              style="width: 150px"
        ...
        <Row :gutter="16">
          ...
          >
            <Input
              v-model="formModel1.fields.householdRegistrationPoliceStation"
              :readonly="true"
              placeholder="户籍派出所"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="房屋编号" prop="numberOfTheHouse">
            <Input
              v-model="formModel1.fields.numberOfTheHouse"
              :readonly="true"
              placeholder="房屋编号"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="无房原因" prop="noRoomReason">
            <Input
              v-model="formModel1.fields.noRoomReason"
              :readonly="true"
              placeholder="无房原因"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="宗教信仰" prop="religiousBelief">
            <Input
              v-model="formModel1.fields.religiousBelief"
              :readonly="true"
              placeholder="宗教信仰"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="有无服务成员" prop="serviceMembers">
            <Input
              v-model="formModel1.fields.serviceMembers"
              :readonly="true"
              placeholder="有无服务成员"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="最新服务时间" prop="latestServiceHours">
            <Input
              v-model="formModel1.fields.latestServiceHours"
              :readonly="true"
              placeholder="最新服务时间"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="罪名" prop="charge">
            <Input
              v-model="formModel.fields.charge"
              placeholder="罪名"
              :readonly="true"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="原判刑期" prop="sentence">
            <Input
              v-model="formModel.fields.sentence"
              placeholder="原判刑期"
              :readonly="true"
            />
          </FormItem>
        ...
        <Row :gutter="16">
          <FormItem label="是否重犯" prop="felony">
            <Input
              v-model="formModel.fields.felony"
              placeholder="是否重犯"
              :readonly="true"
            />
          </FormItem>
    ...
    <Drawer
      title="刑满释放人员清单导入(导入信息时,性别和生日自动从身份证获取,请保证身份证输入正确)"
    ...
    >
      <div>
        ...
        <Button
          ...
          title="刑满释放人员清单导入模板下载"
          >刑满释放人员清单导入模板下载</Button
        >
        <Button
          icon="md-checkmark-circle"
          type="primary"
...
import {
  ...
  GetImport, //导入
  GetExport, //导出
} from "@/api/KeyPoint/ReleasedPrisonInfo";
import config from "@/config";
import { getToken } from "@/libs/util";
export default {
  name: "ReleasedPrisonInfo",
  components: {
    DzTable,
  },
  data() {
    return {
      ...
      formModel: {
        ...
        fields: {
          ...
          residenceAddress: "",
          registeredAddress: "",
          householdRegistrationPoliceStation: "",
          numberOfTheHouse: "",
          currentAddress: "",
          noRoomReason: "",
          otherAddress: "",
  ...
  computed: {
    ...
    selectedRowsId() {
      return this.formModel.selection.map((x) => x.releasedPrisonUuid);
    }, //删除
  },
  methods: {
    //页面加载
    ...
    //右边删除（单个删除）
    handleDelete(row) {
      this.doDelete(row.releasedPrisonUuid);
    },
    doDelete(ids) {
      if (!ids) {
    ...
    handleEdit(row) {
      ...
      this.formModel.opened = true;
      this.handleResetFormDispatch(); //清空表单
      this.doLoadData(row.releasedPrisonUuid);
    },
    //右边详情
    handleDetail(row) {
    ...
    handleimportmodel() {
      ...
      window.location.href =
        this.url + "UploadFiles/KeyPointModel/刑满释放人员清单导入模板.xlsx";
    },
    //导入
    importfxx(e) {
