        ...
        >
          ...
          <template slot-scope="{ row, index }" slot="action">
            ...
            <Tooltip placement="top" content="编辑" :delay="1000" :transfer="true">
              <Button v-can="'edit'" type="primary" size="small" shape="circle" v-if="editquanxian(row)" icon="md-create" @click="handleEdit(row)"></Button>
            </Tooltip>
