      ...
      >
        ...
        <Col span="50">
            <FormItem label="科室/村庄" prop="keshiname">
              <Input type="textarea" :rows="5" v-model="formModel2.fields.keshiname" :readonly="true" placeholder="未知..." />
            </FormItem>
          </Col>
        </Row>
        <Row :gutter="16">
...
export default {
  ...
  data() {
    return {
      DataList: [
        { value: "与我相关", text: "与我相关" },
        { value: "全部任务", text: "全部任务" },
      ], //任务所属
      tableData: [],
      keshidatalist: [], //科室
      filterName: "",
  ...
  methods: {
    ...
    handleSearchRescueteam() {
      this.stores.vote.query.currentPage = 1;
      console.log(this.stores.vote.query.kwfzr);
