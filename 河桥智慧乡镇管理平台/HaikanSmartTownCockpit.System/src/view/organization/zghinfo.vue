      ...
      >
        ...
        <Row :gutter="16">
          <FormItem label="工作" prop="zjWork">
            <Input v-model="formModel.fields.zjWork" :readonly="checkShow()" placeholder="请输入工作" />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="职位" prop="duty">
            <Input v-model="formModel.fields.duty" :readonly="checkShow()" placeholder="请输入职位" />
          </FormItem>
        </Row>
        <Row :gutter="16">
          <FormItem label="地址" prop="houseAddress">
            <Input type="textarea" v-model="formModel.fields.houseAddress" :readonly="checkShow()" placeholder="请输入地址" />
          </FormItem>
        </Row>
      </Form>
...
export default {
  ...
  methods: {
    ...
    handleimportmodel() {
      window.location.href =
        this.url + "UploadFiles/ImportBuidingModel/组织信息导入模板.xlsx";
    },
    //导入
    importfxx(e) {
  ...
  created() {
    ...
    this.actionurl = config.baseUrl.dev + "api/v1/Organization/ZGHInfo/UpLoad";
  },
};
</script>
<style>
