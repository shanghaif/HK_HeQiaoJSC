  ...
  <div>
    ...
    >
      ...
      >
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="号数" prop="zbTime">
              <Input v-model="formModel.fields.zbTime" placeholder="请输入号数" style="width: 400px" />
            </FormItem>
          </Col>
        </Row>
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="值班(住夜)领导" prop="zbLingdao">
              <Input
                v-model="formModel.fields.zbLingdao"
                placeholder="值班(住夜)领导"
                style="width: 400px"
              />
            </FormItem>
          </Col>
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="值班人员" prop="zbrenyuan">
              <Input
                v-model="formModel.fields.zbrenyuan"
                type="textarea"
                placeholder="值班人员"
                style="width: 400px"
              />
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="住夜人员" prop="zyrenyuan">
              <Input
                v-model="formModel.fields.zyrenyuan"
                type="textarea"
                placeholder="住夜人员"
                style="width: 400px"
              />
        ...
        <!-- <Row :gutter="16">
          <Col span="12">
            <FormItem label="时间" prop="paibanInfoTime">
              <DatePicker
                v-model="formModel.fields.paibanInfoTime"
                @on-change="formModel.fields.paibanInfoTime=$event"
                format="yyyy-MM-dd"
                type="date"
                placeholder="时间"
                style="width: 150px"
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="时间段" prop="shijianduan">
              <Select
                filterable
                v-model="formModel.fields.shijianduan"
                style="width:180px"
                placeholder="时间段"
              >
                <Option
...
import {
  ...
  HqCommunaImport, //导入
  HqCommunaExport //导出
} from "@/api/Socialgovernance/WorkManage";
import { globalvalidatezbLingdao } from "@/global/validate";
...
export default {
    ...
    return {
      ...
      formModel: {
        ...
        rules: {
          ...
          zbLingdao: [{ required: true, message: "请输入值班(住夜)领导" }]
        }
      },
      stores: {
        rescueteam: {
          ...
          columns: [
            ...
            { title: "号数", key: "zbTime", sortable: true },
            { title: "值班(住夜)领导", key: "zbLingdao", sortable: true },
            {
              title: "值班人员",
              key: "zbrenyuan",
              ellipsis: true,
  ...
  computed: {
    ...
    selectedRowsId() {
      return this.formModel.selection.map(x => x.paibanInfoUuid);
    }
  },
  methods: {
    loadRescueteamList() {
    ...
    //单条删除
    handleDelete(row) {
      this.doDelete(row.paibanInfoUuid);
    },
    doDelete(ids) {
      if (!ids) {
        this.$Message.warning("请选择至少一条数据");
    ...
    handleEdit(row) {
      ...
      this.doLoadRescueteam(row.paibanInfoUuid);
    },
    ...
    handleimportmodel() {
      ...
      window.location.href =
        this.url + "UploadFiles/ImportUserInfoModel/排班信息导入模板.xlsx";
    },
    //导入
    importfxx(e) {
