  ...
  <div>
    ...
    >
      ...
      >
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="卫生点名称" prop="ygieneName">
              <Input
                v-model="formModel.fields.ygieneName"
                placeholder="请输入卫生点名称"
                style="width: 400px"
                :maxlength="10"
              />
            </FormItem>
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="卫生点地址" prop="ygieneAddress">
              <Input
                v-model="formModel.fields.ygieneAddress"
                placeholder="请输入卫生点地址"
                style="width: 400px"
              />
            </FormItem>
          </Col>
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="监控编号" prop="ygieneMonitorId">
              <Input
                v-model="formModel.fields.ygieneMonitorId"
                placeholder="请输入监控编号"
                style="width: 400px"
              />
            </FormItem>
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="监控类型" prop="ygieneType">
              <Input
                v-model="formModel.fields.ygieneType"
                placeholder="请输入监控类型"
                style="width: 400px"
              />
            </FormItem>
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="监控状态" prop="ygieneStaues">
              <Input
                v-model="formModel.fields.ygieneStaues"
                placeholder="请输入监控状态"
                style="width: 400px"
              />
            </FormItem>
...
import {
  ...
  HqCommunaImport, //导入
  HqCommunaExport //导出
} from "@/api/Socialgovernance/Healthmanagement";
import { globalvalidatePhone } from "@/global/validate";
import { GetfoGet } from "@/api/JingdianInfo/JingdianInfo";
...
export default {
      ...
      stores: {
        rescueteam: {
          ...
          columns: [
            ...
            { title: "卫生点", key: "ygieneName", sortable: true },
            { title: "卫生点地址", key: "ygieneAddress", sortable: true },
            { title: "监控编号", key: "ygieneMonitorId", sortable: true },
            { title: "监控状态", key: "ygieneStaues", sortable: true },
            { title: "监控类型", key: "ygieneType", sortable: true },
  ...
  computed: {
    ...
    selectedRowsId() {
      return this.formModel.selection.map(x => x.ygieneUuid);
    }
  },
  methods: {
    loadRescueteamList() {
    ...
    handleEdit(row) {
      ...
      this.doLoadRescueteam(row.ygieneUuid);
    },
    ...
    handleimportmodel() {
      ...
      window.location.href =
        this.url + "UploadFiles/ImportSocialgoverModel/卫生点信息导入模板.xlsx";
    },
    //导入
    importfxx(e) {
