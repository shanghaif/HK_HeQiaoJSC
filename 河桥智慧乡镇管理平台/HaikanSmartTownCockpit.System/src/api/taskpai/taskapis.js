...
export const getalluseranddep = () => {
    return axios.request({
        url: 'task/task/getalluseranddeps',
        method: 'get',
    })
}
...
//加载树形控件
export const depadnuser = (data) => {
    console.log(data)
	return axios.request({
		url: 'task/task/depadnuser/'+data.keshiuuid,
		method: 'get'
	})
}

export const zhidingrenlist = (data) => {
	return axios.request({
		url: 'task/task/zhidingrenlist/'+data.id,
		method: 'get'
	})
}

export const zhidingren = (data) => {
	return axios.request({
		url: 'task/task/zhidingren',
        method: 'post',
        data
	})
}
