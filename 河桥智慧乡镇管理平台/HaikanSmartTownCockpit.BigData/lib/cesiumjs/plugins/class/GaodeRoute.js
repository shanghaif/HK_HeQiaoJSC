...
class GaodeRoute {
    ...
    _formatRouteData(start, end, resultPaths) {
        ...
        var paths = [];
        if (start) wgs_origin = mapv3d.pointconvert.gcj2wgs(start.split(","));
        if (end) wgs_destination = mapv3d.pointconvert.gcj2wgs(end.split(","));
            ...
            for (var i = 0; i < resultPaths.length; i++) {
                ...
                for (var index = 0; index < steps.length; index++) {
                    ...
                    for (var ind = 0; ind < polylineArr.length; ind++) {
                        ...
                        var wgs = mapv3d.pointconvert.gcj2wgs(one.split(","));
                        route.push(wgs);
                        obj.points.push(wgs);
                    }
    ...
    queryWalking(opt) {
        ...
        //坐标构造
        var startP = mapv3d.pointconvert.wgs2gcj(opt.points[0]);
        var endP = mapv3d.pointconvert.wgs2gcj(opt.points[opt.points.length - 1]);
