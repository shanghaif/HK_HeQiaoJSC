    ...
    var settings = {}, roots = {}, caches = {},
        ...
        data = {
            ...
            nodeName: function (setting, node, newName) {
                ...
                var nameKeys = setting.data.simpleData.nameKeys;
                if ($.isNotEmpty(nameKeys)) {
                    var arrkey = nameKeys.split(",");
                    for (var i = 0; i < arrkey.length; i++) {
                        var val = arrkey[i];
                        if ($.isNotEmpty(node[val])) {
                            return "" + node[val];
                        }
                    }
                }
        ...
        view = {
            ...
            makeNodeIcoStyle: function (setting, node) {
                ...
                if (!node.isAjaxing) {
                    ...
                    var iconKey = setting.data.simpleData.iconKey;
                    if ($.isNotEmpty(iconKey)) {
                        var path = "/img/icon/[icon].png";
                        icon = window.location.origin + path.replace("[icon]", node[iconKey]);
                    }
