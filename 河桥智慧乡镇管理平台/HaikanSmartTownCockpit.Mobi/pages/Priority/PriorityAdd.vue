	...
	<view>
		<form>
			<view class="cu-form-group">
				...
				<textarea v-model="formModel.fields.completed" placeholder="请输入已完成的工作" name="input" style="width: 70%;"></textarea>
			</view>
			<view class="cu-form-group">
				<view class="title" style="width: 28%;"><view style="color:red;float: left;">*</view>需要协调：</view>
				<textarea v-model="formModel.fields.coordination" placeholder="请输入需要协调的工作" name="input" style="width: 70%;"></textarea>
			</view>
			<view>
...
<script>
	...
	export default {
		...
		onLoad(e) {
			this.formModel.fields.priorityUuid = e.uid
		...
		methods: {
			...
			this.formModel.fields.establishName = '7FA89CB5-5C41-49DF-9DD7-4ED6282720AF'
				...
				if (valid != "true") {
					...
					createPersonal3(JSON.stringify(this.formModel.fields)).then(res => {
